...
try:
    ...
    # Create a fallback - app will fail gracefully on DB operations
    client = None
    db = None
...
TRANSLATIONS = {
    "en": {
        ...
        # Events Forecasting UI
        "events_forecasting": "Events Forecasting",
        "live_intelligence": "Live Intelligence",
        "osint_sources_count": "OSINT Sources",
        "categories_count": "Categories",
        "llm_ensemble_count": "LLM Ensemble",
        "auto_refresh": "Auto-Refresh",
        "forecast_range": "Forecast Range",
        "status_operational": "Operational",
        "prediction_categories": "Prediction Categories",
        "judgmental_forecast": "Judgmental Forecast",
        "probability": "Probability",
        "confidence": "Confidence",
        "rationale": "Rationale",
        "methodology": "Methodology",
        "factors_analyzed": "Factors Analyzed",
        # IB Suite
        "ib_suite": "Investment Banking Suite",
        "executive_summary": "Executive Summary",
        "portfolio_risk": "Portfolio Risk",
        "ma_predictions": "M&A Predictions",
        "ipo_timing": "IPO Timing",
        "sector_rotation": "Sector Rotation",
        "market_outlook": "Market Outlook",
        "risk_assessment": "Risk Assessment",
        "key_actions": "Key Actions",
        # Aviation Turbulence
        "aviation_turbulence": "Aviation Turbulence",
        "turbulence_probability": "Turbulence Probability",
...
class RemediationIntelligenceSystem:
    ...
    REMEDIATION_OPTIONS = {
        ...
        "drought": [
            {"id": "DR-001", "name": "Water Rationing", "type": "conservation", "cost_usd": 500000, "speed_hours": 24, "effectiveness": 85, "lives_saved_potential": 5000, "description": "Implement mandatory water rationing for all sectors"},
            {"id": "DR-002", "name": "Emergency Water Supply", "type": "logistics", "cost_usd": 10000000, "speed_hours": 48, "effectiveness": 90, "lives_saved_potential": 20000, "description": "Truck in water from unaffected regions"},
            {"id": "DR-003", "name": "Agricultural Support", "type": "economic", "cost_usd": 50000000, "speed_hours": 72, "effectiveness": 70, "lives_saved_potential": 1000, "description": "Provide emergency support to farmers and ranchers"},
            {"id": "DR-004", "name": "Desalination Activation", "type": "infrastructure", "cost_usd": 25000000, "speed_hours": 168, "effectiveness": 95, "lives_saved_potential": 50000, "description": "Activate emergency desalination facilities"},
            {"id": "DR-005", "name": "Groundwater Emergency Access", "type": "resource", "cost_usd": 5000000, "speed_hours": 24, "effectiveness": 75, "lives_saved_potential": 10000, "description": "Permit emergency groundwater extraction"},
            {"id": "DR-006", "name": "Crop Insurance Activation", "type": "economic", "cost_usd": 100000000, "speed_hours": 48, "effectiveness": 60, "lives_saved_potential": 0, "description": "Trigger crop insurance payouts for affected farmers"},
            {"id": "DR-007", "name": "Livestock Water Points", "type": "agriculture", "cost_usd": 2000000, "speed_hours": 12, "effectiveness": 80, "lives_saved_potential": 0, "description": "Set up emergency watering points for livestock"},
        ],
        "cyclone": [
            {"id": "CY-001", "name": "Cyclone Shelter Activation", "type": "shelter", "cost_usd": 3000000, "speed_hours": 6, "effectiveness": 95, "lives_saved_potential": 100000, "description": "Open all designated cyclone shelters in coastal areas"},
            {"id": "CY-002", "name": "Coastal Evacuation", "type": "evacuation", "cost_usd": 8000000, "speed_hours": 24, "effectiveness": 90, "lives_saved_potential": 50000, "description": "Mandatory evacuation of coastal and low-lying areas"},
            {"id": "CY-003", "name": "Fishing Fleet Recall", "type": "prevention", "cost_usd": 1000000, "speed_hours": 12, "effectiveness": 95, "lives_saved_potential": 5000, "description": "Recall all fishing vessels to safe harbors"},
            {"id": "CY-004", "name": "Storm Surge Barriers", "type": "infrastructure", "cost_usd": 15000000, "speed_hours": 48, "effectiveness": 70, "lives_saved_potential": 20000, "description": "Deploy temporary storm surge barriers"},
            {"id": "CY-005", "name": "Relief Pre-positioning", "type": "logistics", "cost_usd": 20000000, "speed_hours": 36, "effectiveness": 85, "lives_saved_potential": 10000, "description": "Pre-position food, water, medicine outside impact zone"},
            {"id": "CY-006", "name": "Communication Network Hardening", "type": "infrastructure", "cost_usd": 5000000, "speed_hours": 18, "effectiveness": 80, "lives_saved_potential": 2000, "description": "Protect critical communication infrastructure"},
        ],
        "blizzard": [
            {"id": "BL-001", "name": "Travel Ban", "type": "prevention", "cost_usd": 200000, "speed_hours": 1, "effectiveness": 95, "lives_saved_potential": 500, "description": "Implement travel ban on all non-essential vehicles"},
            {"id": "BL-002", "name": "Warming Centers", "type": "shelter", "cost_usd": 1000000, "speed_hours": 4, "effectiveness": 90, "lives_saved_potential": 2000, "description": "Open warming centers for homeless and vulnerable populations"},
            {"id": "BL-003", "name": "Power Grid Protection", "type": "infrastructure", "cost_usd": 5000000, "speed_hours": 6, "effectiveness": 75, "lives_saved_potential": 1000, "description": "Pre-emptive grid load management and backup activation"},
            {"id": "BL-004", "name": "Snow Removal Fleet", "type": "response", "cost_usd": 3000000, "speed_hours": 2, "effectiveness": 85, "lives_saved_potential": 300, "description": "Deploy maximum snow removal equipment"},
            {"id": "BL-005", "name": "Medical Team Standby", "type": "medical", "cost_usd": 2000000, "speed_hours": 3, "effectiveness": 90, "lives_saved_potential": 500, "description": "Pre-position medical teams at key locations"},
            {"id": "BL-006", "name": "School/Business Closure", "type": "prevention", "cost_usd": 100000, "speed_hours": 0.5, "effectiveness": 95, "lives_saved_potential": 200, "description": "Order closure of schools and non-essential businesses"},
            {"id": "BL-007", "name": "Stranded Motorist Rescue", "type": "rescue", "cost_usd": 1500000, "speed_hours": 1, "effectiveness": 80, "lives_saved_potential": 100, "description": "Deploy rescue teams for stranded motorists"},
        ],
        "snow_storm": [
            {"id": "SN-001", "name": "Winter Storm Warning", "type": "warning", "cost_usd": 50000, "speed_hours": 0.25, "effectiveness": 95, "lives_saved_potential": 1000, "description": "Broadcast winter storm warnings through all channels"},
            {"id": "SN-002", "name": "Salt/Sand Pre-treatment", "type": "prevention", "cost_usd": 500000, "speed_hours": 6, "effectiveness": 80, "lives_saved_potential": 200, "description": "Pre-treat roads with salt and sand"},
            {"id": "SN-003", "name": "Airport Deicing Operations", "type": "transportation", "cost_usd": 2000000, "speed_hours": 2, "effectiveness": 85, "lives_saved_potential": 50, "description": "Activate maximum deicing operations at airports"},
            {"id": "SN-004", "name": "Emergency Heating Fuel", "type": "logistics", "cost_usd": 3000000, "speed_hours": 12, "effectiveness": 90, "lives_saved_potential": 500, "description": "Distribute emergency heating fuel to vulnerable households"},
            {"id": "SN-005", "name": "Utility Crew Mobilization", "type": "infrastructure", "cost_usd": 4000000, "speed_hours": 4, "effectiveness": 85, "lives_saved_potential": 300, "description": "Mobilize all utility crews for rapid outage response"},
        ],
        "ice_storm": [
            {"id": "IC-001", "name": "Power Outage Preparation", "type": "infrastructure", "cost_usd": 3000000, "speed_hours": 6, "effectiveness": 80, "lives_saved_potential": 500, "description": "Pre-position repair crews and equipment for grid damage"},
            {"id": "IC-002", "name": "Tree Trimming Emergency", "type": "prevention", "cost_usd": 2000000, "speed_hours": 24, "effectiveness": 70, "lives_saved_potential": 100, "description": "Emergency trimming of trees near power lines"},
            {"id": "IC-003", "name": "Generator Distribution", "type": "logistics", "cost_usd": 5000000, "speed_hours": 8, "effectiveness": 85, "lives_saved_potential": 1000, "description": "Distribute portable generators to critical facilities"},
            {"id": "IC-004", "name": "Road Treatment", "type": "prevention", "cost_usd": 1000000, "speed_hours": 4, "effectiveness": 75, "lives_saved_potential": 200, "description": "Apply de-icing chemicals to critical roadways"},
            {"id": "IC-005", "name": "Shelter Operations", "type": "shelter", "cost_usd": 1500000, "speed_hours": 6, "effectiveness": 90, "lives_saved_potential": 800, "description": "Open emergency shelters with heating"},
        ],
        "heatwave": [
            {"id": "HW-001", "name": "Cooling Centers", "type": "shelter", "cost_usd": 500000, "speed_hours": 2, "effectiveness": 95, "lives_saved_potential": 5000, "description": "Open air-conditioned cooling centers throughout affected area"},
            {"id": "HW-002", "name": "Wellness Checks", "type": "medical", "cost_usd": 1000000, "speed_hours": 4, "effectiveness": 85, "lives_saved_potential": 2000, "description": "Door-to-door wellness checks on elderly and vulnerable"},
            {"id": "HW-003", "name": "Water Distribution", "type": "logistics", "cost_usd": 300000, "speed_hours": 2, "effectiveness": 90, "lives_saved_potential": 3000, "description": "Free water distribution at public locations"},
            {"id": "HW-004", "name": "Extended Pool Hours", "type": "relief", "cost_usd": 200000, "speed_hours": 1, "effectiveness": 70, "lives_saved_potential": 500, "description": "Extend public pool and spray park hours"},
            {"id": "HW-005", "name": "Power Grid Surge Planning", "type": "infrastructure", "cost_usd": 2000000, "speed_hours": 6, "effectiveness": 80, "lives_saved_potential": 1000, "description": "Manage grid load to prevent blackouts during peak AC usage"},
            {"id": "HW-006", "name": "Hospital Surge Capacity", "type": "medical", "cost_usd": 5000000, "speed_hours": 8, "effectiveness": 90, "lives_saved_potential": 1500, "description": "Activate hospital surge capacity for heat-related illness"},
        ],
        "landslide": [
            {"id": "LS-001", "name": "Evacuation Order", "type": "evacuation", "cost_usd": 2000000, "speed_hours": 2, "effectiveness": 95, "lives_saved_potential": 5000, "description": "Mandatory evacuation of landslide-prone areas"},
            {"id": "LS-002", "name": "Road Closures", "type": "prevention", "cost_usd": 100000, "speed_hours": 0.5, "effectiveness": 90, "lives_saved_potential": 500, "description": "Close roads in unstable terrain"},
            {"id": "LS-003", "name": "Slope Monitoring", "type": "monitoring", "cost_usd": 500000, "speed_hours": 1, "effectiveness": 85, "lives_saved_potential": 2000, "description": "Deploy slope movement sensors"},
            {"id": "LS-004", "name": "Drainage Enhancement", "type": "mitigation", "cost_usd": 3000000, "speed_hours": 24, "effectiveness": 70, "lives_saved_potential": 1000, "description": "Improve drainage to reduce water saturation"},
            {"id": "LS-005", "name": "Search & Rescue Standby", "type": "rescue", "cost_usd": 1500000, "speed_hours": 1, "effectiveness": 80, "lives_saved_potential": 500, "description": "Pre-position search and rescue teams"},
        ]
    }
