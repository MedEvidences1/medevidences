    ...
    competitors: [
      {
        ...
        isUs: true,
        features: {
          "Judgmental Forecasting": { value: "Proprietary", details: "Multi-factor Bayesian engine", highlight: true },
          "AI Models": { value: "3 LLMs", details: "GPT-4 + Claude + Gemini", highlight: true },
          "OSINT Sources": { value: "1M+", details: "Global aggregation" },
          "Prediction Categories": { value: "10+", details: "Economics, Geopolitical, Tech, etc." },
          "Backtesting": { value: "✓", details: "Historical validation", highlight: true },
          "Disaster Integration": { value: "✓", details: "27 agencies, 57K+ IoT", highlight: true },
          "Investment Banking": { value: "Full Suite", details: "M&A, IPO, Risk", highlight: true },
          "Vedic Astrology": { value: "✓", details: "Curated predictions", highlight: true },
          "Multi-language": { value: "6", details: "EN, ES, FR, AR, ID, SW" },
          "Calibration Tracking": { value: "Brier Score", details: "Accuracy validation", highlight: true },
        }
      },
      {
        name: "Mantic.com",
        features: {
          "Judgmental Forecasting": { value: "Proprietary", details: "DeepMind-founded AI" },
          "AI Models": { value: "1 LLM", details: "Proprietary model" },
          "OSINT Sources": { value: "1M+", details: "Research integration" },
          "Prediction Categories": { value: "5+", details: "Geopolitics, Business, Policy" },
          "Backtesting": { value: "✓", details: "Historical simulation" },
          "Disaster Integration": { value: "Limited", details: "Not primary focus" },
          "Investment Banking": { value: "✗", details: "Not available" },
          "Vedic Astrology": { value: "✗", details: "Not available" },
          "Multi-language": { value: "1", details: "English only" },
          "Calibration Tracking": { value: "✓", details: "Client-validated" },
        }
      },
      {
        name: "Metaculus",
        features: {
          "Judgmental Forecasting": { value: "Crowd", details: "Human forecasters" },
          "AI Models": { value: "AI-assisted", details: "Hybrid approach" },
          "OSINT Sources": { value: "Limited", details: "User-sourced" },
          "Prediction Categories": { value: "10+", details: "Broad coverage" },
          "Backtesting": { value: "✓", details: "Track record" },
          "Disaster Integration": { value: "✗", details: "Not available" },
          "Investment Banking": { value: "✗", details: "Not available" },
          "Vedic Astrology": { value: "✗", details: "Not available" },
          "Multi-language": { value: "1", details: "English" },
          "Calibration Tracking": { value: "✓", details: "Public leaderboards" },
        }
      },
      {
        name: "OneConcern",
        features: {
          "Judgmental Forecasting": { value: "✗", details: "Risk scoring only" },
          "AI Models": { value: "1 LLM", details: "Proprietary" },
          "OSINT Sources": { value: "Limited", details: "Disaster-focused" },
          "Prediction Categories": { value: "3", details: "Earthquake, Flood, Fire" },
          "Backtesting": { value: "Limited", details: "Historical events" },
          "Disaster Integration": { value: "✓", details: "Primary focus" },
          "Investment Banking": { value: "✗", details: "Not available" },
          "Vedic Astrology": { value: "✗", details: "Not available" },
          "Multi-language": { value: "2-3", details: "Limited" },
          "Calibration Tracking": { value: "✗", details: "Not public" },
        }
      }
    ]
  };
