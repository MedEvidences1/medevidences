    ...
    <header className="border-b border-[#1F1F1F] bg-[#050505] sticky top-0 z-50">
      <div className="flex items-center justify-between px-6 py-3">
        <div className="flex items-center gap-4 flex-shrink-0">
          ...
          <Badge variant="outline" className="text-xs border-[#1F1F1F] text-[#888] hidden sm:inline-flex">
            v1.0.0
          </Badge>
        </div>

        <nav className="hidden lg:flex items-center gap-1 overflow-x-auto flex-1 mx-4 justify-center">
...
const Disasters = ({ getHeaders, pendingRemediation, clearPendingRemediation }) => {
  ...
  const views = [
    ...
    { id: "space_launch", label: "SPACE LAUNCH", icon: Rocket },
    { id: "military", label: "MILITARY", icon: Shield },
    { id: "high_altitude", label: "HIGH-ALT LOGISTICS", icon: Cloud },
    ...
    { id: "sensors", label: "SATELLITES/IOT", icon: Satellite },
          ...
          <Card className="terminal-card border-l-4 border-l-[#9D4EDD]">
            <CardHeader className="pb-2">
              <div className="flex items-center justify-between">
                <CardTitle className="text-sm flex items-center gap-2">
                  <Sparkles className="w-4 h-4 text-[#9D4EDD]" />
                  AI DISASTER PREDICTIONS 2026-3000
                  <Badge className="bg-[#9D4EDD]/20 text-[#9D4EDD]">MULTI-LLM</Badge>
                </CardTitle>
